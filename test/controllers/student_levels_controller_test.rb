...
class StudentLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_level" do
    assert_difference('StudentLevel.count') do
      post student_levels_url, params: { student_level: { generic_text: @student_level.generic_text, level_name: @student_level.level_name, user_id: @student_level.user_id } }
    end
  ...
  test "should update student_level" do
    patch student_level_url(@student_level), params: { student_level: { generic_text: @student_level.generic_text, level_name: @student_level.level_name, user_id: @student_level.user_id } }
